  ...
  <div class="rooms-page">
    ...
    <div class="pt-2 pb-4">
      <NuxtLink to="/rooms/create">
        <Button class="p-button-primary shadow-sm">{{
          $t("rooms.create")
        }}</Button>
      </NuxtLink>
    </div>
          ...
          <div class="room-card-container">
            ...
            >
              ...
              >
                ...
                <span class="text-xs">{{
                  new Date(room.room.created_at) | dateFormat("YYYY.MM.DD")
                }}</span>
              </div>
            </a>
          </div>
...
export default {
  ...
  methods: {
    ...
    showScroll() {
      console.log(
        document.querySelector(".el-for-scroll").scrollTop,
