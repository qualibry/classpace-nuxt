    ...
    <div>
        ...
        <div class="grid">
            <div class="col-12 xl:col-8">
                <div class="text-sm">{{ $t('rooms.roomCreator') }}: <b>{{ room.author.full_name }}</b></div>
...
export default {
    components: {
        Button, Divider, InputText, Participants, Menu,
        ConfirmDialog, PostList, SelectButton,
    },
    mounted() {
    },
    computed: {
    ...
    watch: {
        async '$route.query'() {
            await this.$store.dispatch('roomposts/fetch', {
                ...this.$route.query,
